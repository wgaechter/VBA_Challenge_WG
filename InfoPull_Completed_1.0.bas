...
Sub InfoPull()
    ...
    Dim SummaryIncrease As Double
    Dim SummaryDecrease As Double
    ...
    For Each ws In Worksheets
        ...
        'USING MIN/MAX FUNCTIONS TO FIND HIGH/LOW VALUES
        ...
        'CELL SEARCHES FOR TICKER WITH MIN/MAX VALUES
        
        For i = 2 To lastrow_summary
            If ws.Cells(i, 11) = SummaryIncrease Then
                ws.Cells(i, 9).Copy ws.Range("O2")
            End If
        Next i

        For i = 2 To lastrow_summary
            If ws.Cells(i, 11) = SummaryDecrease Then
                ws.Cells(i, 9).Copy ws.Range("O3")
            End If
        Next i

        For i = 2 To lastrow_summary
            If ws.Cells(i, 12) = SummaryMax Then
                ws.Cells(i, 9).Copy ws.Range("O4")
            End If
        Next i
        
        'RESIZE ALL USED COLUMNS
